...
const ItemListVertical = ({navigation}) => {
  const items = [
    {
          ...
          <View style={styles.itemlvw}>
            ...
            <View style={styles.TextW}>
              ...
              <View style={styles.IconM}>
                <View style={styles.IconSW}>
                  <Image
                    source={require('../Images/pages.png')}
                    style={styles.Icons}
                  />
                  <Text style={{marginLeft: 5}}>{item.Pages}</Text>
                </View>
                <View style={styles.IconSW}>
                  <Image
              ...
              <View style={styles.Genre}>
                <Text style={{color: 'green'}}>{item.Genre}</Text>
              </View>
            </View>
          </View>
        </TouchableOpacity>
